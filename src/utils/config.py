...
data_path: str = '/Users/wangruiqian/Documents/数据/智能营销/train.txt'
val_data_path: Optional[str] = '/Users/wangruiqian/Documents/数据/智能营销/dev.txt'
test_data_path: Optional[str] = '/Users/wangruiqian/Documents/数据/智能营销/test.txt'
